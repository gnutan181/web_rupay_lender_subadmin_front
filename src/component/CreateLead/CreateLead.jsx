...
//     // { id: "professional-loan", name: "Professional Loan", icon: <FaBuildingShield /> },
// ];
...
//         try {
//             const response = await axios.get(`/subAdmin/vendor-lead?phone=${phoneNumber}`);
...
//             <div className="mb-6">
//                 <label className="block text-sm font-medium text-gray-700">Search Phone Number to create lead...</label>
...
//                         <input className="p-2 border border-gray-300 rounded-md w-full" value={leadData.venderID} readOnly />
//                     </div>
//                     <div>
//                         <label className="block text-sm font-medium text-gray-700 mb-1">Name:</label>
//                         <input className="p-2 border border-gray-300 rounded-md w-full" value={leadData.name} readOnly />
//                     </div>
//                     <div>
//                         <label className="block text-sm font-medium text-gray-700 mb-1">Number:</label>
//                         <input className="p-2 border border-gray-300 rounded-md w-full" value={leadData.number} readOnly />
//                     </div>
//                     <div>
//                         <label className="block text-sm font-medium text-gray-700 mb-1">State:</label>
//                         <input className="p-2 border border-gray-300 rounded-md w-full" value={leadData.state} readOnly />
//                     </div>
//                     <div>
//                         <label className="block text-sm font-medium text-gray-700 mb-1">City:</label>
//                         <input className="p-2 border border-gray-300 rounded-md w-full" value={leadData.city} readOnly />
//                     </div>
//                     <div>
//                         <label className="block text-sm font-medium text-gray-700 mb-1">Pincode:</label>
//                         <input className="p-2 border border-gray-300 rounded-md w-full" value={leadData.pincode} readOnly />
//                     </div>
//                 </div>
//             )}
...
//                                 }`}
//                         >
//                             <div className={`text-3xl text-[#F89D28] ${selectedService === service.id ? "bg-[#F89D28] text-[#FFF]" : ""}`}>{service.icon}</div>
