...
const HLBT = ({ mobile }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (profession === "job") {
      apiEndpoint = `/subAdmin/home-job-bt/${mobile}`;
    } else if (profession === "business") {
      apiEndpoint = `subAdmin/home-business-bt/${mobile}`;
    } else {
  ...
  return (
    <>
      <h1 className="text-[1.6rem] font-bold mt-10">Home Loan Balance Transfer</h1>
